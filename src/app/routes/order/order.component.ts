...
export class OrderComponent implements OnInit {
  ...
  constructor(public route : Router, 
    ...
    this.routeService.getRoute(this.data.route_id).subscribe(result =>{
      ...
      // this.client_email_content = this.constructEmailMessageClient(this.curRoute.starting_date, this.curRoute.points[0].address + '- '+this.curRoute.points[0].country, this.curRoute.arrival_date, this.curRoute.points[1].address + '- '+this.curRoute.points[1].country, this.getTotal().toFixed(2),this.curRoute.passengers && this.curRoute.passengers[0].birthday, this.curRoute.take_at_home)
  ...
  client_email_content_(){
    return this.curRoute ?  this.constructEmailMessageClient(this.curRoute.starting_date, this.curRoute.points[0].address + '- '+this.curRoute.points[0].country, this.curRoute.arrival_date, this.curRoute.points[1].address + '- '+this.curRoute.points[1].country, this.getTotal().toFixed(2),this.reservation.passengers && this.reservation.take_to_home_adr, this.reservation.take_at_home) : ''
  }
    ...
    this.routeService.getRoute(this.data.route_id).subscribe(result =>{
      ...
      if(!this.reservation.id){
        ...
        this.reservationService.post(this.data).subscribe(result =>{
          ...
          const curRoute : Reservation = this.curRoute
          
          // console.log(result, this.data)
          // this.loading = false
          
          this.text_mail_for_reservation = this.client_email_content_()
...
return reservation_t
  ...
  constructEmailMessageClient(
    ...
    return `
      <p><strong>Dear passenger,&nbsp;<br /> <span style="color: #3366ff;">Cher passagers</span>&nbsp;</strong></p>
<p><strong><em>Your reservation has been taken into account; however, i</em></strong><strong>t will be confirmed upon receipt of the proof of transfer to the following account&nbsp; :<br /></strong><strong><span style="color: #3366ff;">Votre r&eacute;servation a &eacute;t&eacute; prise en compte, cependant elle sera confirm&eacute;e d&egrave;s la r&eacute;ception de la preuve de virement &nbsp;sur le compte&nbsp; suivant :<br /> <br /></span></strong></p>
...
<p><strong>Send the proof on the emai<u>l</u></strong> <a href="mailto:besomewhere.reservation@gmail.com"><strong>besomewhere.reservation@gmail.com</strong></a><strong><u>&nbsp;&nbsp;</u></strong></p>
<p><span style="color: #3366ff;"><strong>Envoyer la preuve sur l&rsquo;email</strong></span> <a href="mailto:besomewhere.reservation@gmail.com"><strong>besomewhere.reservation@gmail.com</strong></a>&nbsp;</p>
...
<p><strong>&nbsp;<span style="color: #3366ff;">-&gt;Si vous payez avec du cash, pour confirmer votre r&eacute;servation, envoyez aussi un message &agrave;&nbsp;</span><span style="text-decoration: underline;"><span style="color: #3366ff; text-decoration: underline;"><a href="mailto:besomewhere.reservation@gmail.com">besomewhere.reservation@gmail.com</a></span></span></strong></p>
<p><strong><span style="color: #3366ff;">En Indiquant le nom de la r&eacute;servation&nbsp; avec la mention&nbsp; <span style="text-decoration: underline;">&laquo; je paie en cash &raquo;.</span>&nbsp;</span>&nbsp;<span style="color: #3366ff;">Veuillez noter que le paiement en esp&egrave;ces entra&icirc;ne des frais suppl&eacute;mentaires de 5 &euro;.</span></strong></p>
<p>&nbsp;</p>
<h3><span style="text-decoration: underline; color: #ff0000;"><strong>You must do it within a</strong> maximum <strong>of one hour,&nbsp;otherwise your reservation may be cancelled.</strong></span></h3>
<h3><span style="text-decoration: underline;"><span style="color: #3366ff; text-decoration: underline;"><strong><span style="color: #ff0000; text-decoration: underline;">&nbsp;</span><span style="color: #ff0000; text-decoration: underline;">Vous devez le faire dans un d&eacute;lai de maximum une heure,&nbsp;&nbsp;sous&nbsp; peine de voir votre r&eacute;servation annul&eacute;</span>.</strong></span></span></h3>
<p>&nbsp;</p>
<p>&nbsp;</p>
<h1 style="text-align: center;"><strong>Information</strong></h1>
<h4><em><br /></em> <em><em>Your departure address is</em><em>&nbsp;from&nbsp;</em><em>${departurePoint}&nbsp; the ${departureDate}<br /></em></strong></em> <em><strong><em>Your arrival addres is &nbsp;</em></strong></em>${destinationPoint}<em><strong>&nbsp; the ${destinationDate}.</strong></em><em><strong><em><br /></em></strong></em><span style="color: #3366ff;"><strong>Votre adresse de d&eacute;part est  ${departurePoint} le ${departureDate}<br /></strong></span><span style="color: #3366ff;"><strong>Votre adresse d'arriv&eacute; est ${destinationPoint} le ${destinationDate}&nbsp;</strong></span></h4>

 ${take_at_home ? `<p><strong><em><strong><em>In the case you have selected the option "come to my door" : Oui. Your pick up or drop off adress is&nbsp; ${take_at_home_adr} , in the case of pick up be sure to be ready 30 minutes before the initial schedule time&nbsp;<br /></em></strong></em></strong><span style="color: #3366ff;"><strong>Dans le cas o&ugrave; vous avez s&eacute;lectionn&eacute; l'option &laquo; venir &agrave; ma porte &raquo; : Oui. . Votre adresse de prise en charge ou de d&eacute;p&ocirc;t est  ${take_at_home_adr}. Dans le cas d'un d&eacute;part, assurez-vous d'&ecirc;tre pr&ecirc;t 30 minutes avant l'heure initialement pr&eacute;vue.</strong></span></p> ` : ''}


<p><strong><em><strong><em>&nbsp;</em></strong></em></strong></p>
<p><strong><em><strong><em>You&nbsp;</em></strong>can check the departure and arrival addresses in the section &lsquo;My Current trip' on your Besomewhereapp.com account.&nbsp;<br /></em></strong><span style="color: #3366ff;"><strong>Il vous est possible de consulter l&rsquo;adresse de d&eacute;part&nbsp; et d&rsquo;arriv&eacute; dans la rubrique &laquo;&nbsp;Mes trajets en cours&nbsp;&raquo; sur votre compte Besomewhereapp.com</strong></span></p>
<h4><span style="text-decoration: underline;"><strong><em><span style="color: #800000; text-decoration: underline;">We remind you that it is mandatory for the passenger to be present precisely at the address mentioned up to 15 minutes before the scheduled departure time.</span><br /></em></strong><span style="color: #ff0000; text-decoration: underline;"><strong>Nous rappelons qu&rsquo;il&nbsp; est obligatoire pour le passager de se pr&eacute;senter pr&eacute;cis&eacute;ment devant&nbsp; l&rsquo;adresse mentionn&eacute; jusqu&rsquo;&agrave; 15 minutes avant l&rsquo;heure de passage.</strong></span></span></h4>
<h4><strong><em>If you have selected 'Come to My Door' option, you will be contacted within 12 hours following the reservation and 10 minutes before the driver arrives.<br /></em></strong><span style="color: #3366ff;"><strong>Si vous avez s&eacute;lectionn&eacute; l&rsquo;option &laquo;&nbsp;venir jusqu&rsquo;&agrave; ma porte&nbsp;&raquo; vous serez co ntact&eacute;,&nbsp; dans les 12h suivant la r&eacute;servation et 10 minutes avant le passage du conducteur.</strong></span></h4>
<h4><strong><em>You must be in front of the address before the driver arrives; otherwise, he will not be able to pick you up. The driver is not authorized to wait for the passenger as it would cause delays for all passengers. It is your responsibility to ensure that you can be reached by local phone number</em> <em>WhatsApp, Telegram, or Signal</em> <em>&nbsp;:<br /></em></strong><span style="color: #3366ff;"><strong>Vous devez &ecirc;tre devant l&rsquo;adresse avant l&rsquo;arriv&eacute;e du conducteur, autrement il ne pourra pas vous r&eacute;cup&eacute;rer. &nbsp;Le conducteur n&rsquo;a aucune autorisation pour attendre le passager car cela occasionnera du retard pour tous les passagers. Il est de votre responsabilit&eacute; de vous assurer <u>d&rsquo;&ecirc;tre joignable avec un num&eacute;ro local, whattaps, telegram ou signal.</u></strong></span></h4>
...
<h4><strong>We remind you that Besomewhere is not in control of the traffic; it cannot be held responsible for traffic slowdowns or road closures. It is the responsibility of the traveler to allow for sufficient margin with the time of their fligh.<br /></strong><span style="color: #3366ff;"><strong>Nous rappelons que Besomewhere n&rsquo;est pas maitre de la route, il ne pourra &ecirc;tre tenu responsable pour&nbsp; un ralentissement de la circulation ou une route ferm&eacute;. Il est de la responsabilit&eacute; du voyageur de prendre suffisamment de marge avec l&rsquo;heure de son vol.</strong></span></h4>
<h4><strong><em>We also remind passengers that it is recommended to allow for a margin of at least one hour between the landing time of the flight and the</em></strong> <em>departure time of the Besomewhere transport. Besomewhere must start on time without any condition, in order to avoid accumulating</em> <em>delays. The passenger may then be accommodated for the next departure, provided if there iq a available seat&nbsp; and if the delay can be proven due to a flight-related reason.<br /></em><span style="color: #3366ff;"><strong>Nous rappelons &eacute;galement qu'Il est recommand&eacute; pour le passager de prendre une marge d&rsquo;au moins une heure entre l&rsquo;heure d&rsquo;atterrissage du vol et l&rsquo;heure de d&eacute;part du transport Besomewhere qui devra sans condition d&eacute;marrer &agrave; l&rsquo;heure, dans le but de ne pas accumuler de retard. Le passager pourra alors &ecirc;tre r&eacute;cup&eacute;r&eacute; pour le prochain d&eacute;part &agrave; condition d&rsquo;avoir une place de disponible si le retard peut &ecirc;tre prouv&eacute; pour cause de vol.</strong></span></h4>
<h4><strong>&nbsp;</strong><strong><em>You can find our sales, support, and cancellation policy in our</em> <a href="https://besomewhereapp.com/#/conditions-de-vente" target="_blank"><em>general terms and conditions of sale</em></a><em><br /></em> <span style="color: #3366ff;">Vous pouvez retrouver notre politique de vente, de prise en charge et d&rsquo;annulation dans nos</span> <a href="https://besomewhereapp.com/#/conditions-de-vente" target="_blank">conditions de vente g&eacute;n&eacute;rales</a></strong></h4>
<h4><strong>And especially to not forget anything, use our <a href="https://besomewhereapp.com/#/mes-checklists?archived=false" target="_blank">help to pack your suitcase</a></strong><br /> <span style="color: #3366ff;"><strong>Et surtout pour ne rien oubliez utiliser notre <a href="https://besomewhereapp.com/#/mes-checklists?archived=false" target="_blank">aide pour faire votre valise</a>,</strong></span></h4>
<p>&nbsp;</p>
<p><strong><em>For any questions, please contact"</em></strong></p>
<p><span style="color: #3366ff;"><strong>Pour toute question adressez-vous&nbsp; &agrave;</strong></span></p>
<p><br /> <span style="color: #3366ff;"><strong><a style="color: #3366ff;" href="mailto:Besomewhere.contact@gmail.com">Besomewhere.contact@gmail.com</a></strong></span></p>
<h4><br /> <strong>Wherever you are, Besomewhere is with you</strong><br /> <span style="color: #3366ff;"><strong>Partout o&ugrave; vous &ecirc;tes il y&rsquo;a Besomewhere avec vous</strong></span></h4>
