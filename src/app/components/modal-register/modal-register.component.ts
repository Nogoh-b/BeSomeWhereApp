...
export class ModalRegisterComponent implements OnInit {
  ...
  bookingConfirmationText: string = `Dear passenger, Cher passagers, Welcome to the BESOMEWHERE community you are ready to embark to an incredible adventure with our platform that will assists you throughout your entire journey. From your departure to your return commitment is our motto. Bienvenue dans communauté Besomewhere, vous êtes prêt à commencer une aventure incroyable grâce à notre plateforme qui vous assiste durant toute la durée de votre voyage. De votre départ, à votre retour, engagement est notre mot d’ordre. Start by booking your ride to the airport by clicking here. Commencer par réserver votre trajet vers l'aéroport en cliquant ici. But that's not all; don't rush too quickly. Besomewhere also helps you prepare and organize your suitcases through the free suitcase preparation assistance service accessible by clicking here. Ce n'est pas tout ne partez pas trop vite Besomewhere vous aide également à préparer et organiser vos valises via le service gratuit d'aide à la préparation de valise accessible en cliquant ici. This way, you can travel in peace while reading our travel tips based on your destination, during your journey, in the articles section accessible here. Vous pourriez ainsi voyager en paix tout en lisant nos conseils de voyage en fonction de votre destination, pendant votre trajet, dans la rubrique articles accessible ici. For any questions, please contact Pour toute question adressez-vous à Besomewhere.contact@gmail.com Wherever you are, Besomewhere is with you Partout où vous êtes il y’a Besomewhere avec vous Besomewhere`;
