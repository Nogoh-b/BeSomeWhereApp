...
export class RouteCardComponent implements OnInit {
  ...
  getTotal(){
    ...
    var passengers_price = /*this.passengers > 1 ?*/ (this.route.price* this.passengers  + tah * this.take_at_home_count ) //: this.route.price
    var items_price = this.items && this.curStatus >= globals.TrajetCardStatus.Ordering  ?  this.total_price_babyseats()+ this.total_price_meals()+ this.total_price_suitcase() : 0
