import { take_at_home_price, email_admin, SERVER_URL } from './../../../global';
...
export class OrderComponent implements OnInit {
  ...
  total_price_passenger(with_take_at_home: boolean  ){
    ...
    return(sup *  this.takeAtHomeCount(this.reservation.passengers,this.reservation.take_at_home)  +  g.length * this.curRoute.price)
  }
